import { buildArtifact, type BuildArtifactOptions, type OatArtifact } from '@johnhenry/oat-protocol';

/**
 * Thin seam over `@johnhenry/oat-protocol`'s `buildArtifact` — kept as its own module
